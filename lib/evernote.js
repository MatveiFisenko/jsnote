var E = {
	...
	updateNote: function(e, data) {
		...
		//update sha1 after successfull save, but not earler
		//TODO can be problem if user updates one note, quickly starts new one and saves it
		E.data.activeNote.sha1 = E.data.activeNote.sha1Pending;

		if (E.data.activeNote.guid === 'createNote') {//if we created new note - save it's guid as active. Prevents creating a lot of new notes.
