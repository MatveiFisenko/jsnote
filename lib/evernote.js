...
//			console.log(data);
	...
	getNoteContent: function(e, data) {
		...
		if (e) {
			...
			E.data.activeNote.guid = noteId[2];

			if (noteId[1]) {//if we clicked on history tab - get cached content
		...
		//TODO active note can be changed already. Possible use guid from ajax request
