var E = {
	...
	updateNote: function(e, data) {
		...
		if (E.data.activeNote === 'createNote') {//if we created new note - save it's guid as active. Prevents creating a lot of new notes.
			E.data.activeNote = data.guid;
		}
	},

	createNote: function(e, data) {
		if (e) {
			E.data.activeNote = 'createNote';//hack used in backend to create new note
